...
function DeliveryPage() {
    const [orders, setOrders] = useState<Order[]>(mockOrders.filter(o => o.type === 'Delivery' && o.status !== 'Cancelled'));

  return (
    <>
      <PageHeader title="Delivery Orders">
        <Button asChild>
            <Link href="/delivery/new"><PlusCircle className="mr-2"/> New Delivery Order</Link>
        </Button>
      </PageHeader>
